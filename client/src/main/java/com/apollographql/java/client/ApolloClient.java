...
//      return this;
    ...
    @Override
    public Builder url(@Nullable String s) {
      this.url = url;
      return this;
    }

    @Override
    public Builder ignoreUnknownKeys(@Nullable Boolean ignoreUnknownKeys) {
      this.ignoreUnknownKeys = ignoreUnknownKeys;
      return this;
    }
